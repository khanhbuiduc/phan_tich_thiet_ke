...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\detokenize{content/source/mermaid_sequence/IMG/Luồng ingest tài liệu RAG.png}}
    \caption{Biểu đồ tuần tự luồng ingest tài liệu RAG}
    \label{fig:seq-rag-document-ingest}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\detokenize{content/source/mermaid_activity/act_08.png}}
    \caption{Biểu đồ hoạt động luồng ingest tài liệu RAG}
    \label{fig:act-rag-document-ingest}
\end{figure}
