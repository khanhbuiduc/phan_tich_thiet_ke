\subsection{Thiết kế dashboard và nhóm báo cáo quản trị}
...
\subsubsection{Báo cáo người dùng}
...
\subsubsection{Báo cáo hội thoại}
...
\subsubsection{Báo cáo tài liệu}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{\detokenize{content/source/hình 7.2 dashboard quản trị tổng quan.png}}
