\subsection{Thiết kế luồng nghiệp vụ phân hệ quản trị}

\subsubsection{Luồng quản lý tài liệu biểu mẫu}
...
\subsubsection{Luồng quản lý tài liệu RAG}
...
\subsubsection{Luồng phân quyền người dùng}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=0.78\textheight,keepaspectratio]{\detokenize{content/source/mermaid_activity/IMG/Luồng phân quyền RBAC.png}}
    \caption{Biểu đồ hoạt động luồng phân quyền RBAC}
    \label{fig:act-rbac-authorization}
\end{figure}

\subsubsection{Luồng xem báo cáo thống kê}
